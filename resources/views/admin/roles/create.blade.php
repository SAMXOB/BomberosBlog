...
<div style="max-width: 600px;">
    <h2 style="margin-bottom: 30px;">Crear Nuevo Rol</h2>
            ...
            <div style="max-height: 300px; overflow-y: auto; border: 1px solid #dee2e6; padding: 10px; border-radius: 5px;">
                @foreach ($permissions as $permission)
                    <div style="margin-bottom: 10px;">
                        <input type="checkbox" id="perm_{{ $permission->id }}" name="permissions[]" value="{{ $permission->name }}" {{ in_array($permission->name, old('permissions', [])) ? 'checked' : '' }}>
